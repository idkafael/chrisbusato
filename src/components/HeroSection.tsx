  ...
  return (
    <section className="px-4 pt-4 pb-4">
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at 80% 10%, #C4A88233 0%, transparent 55%), radial-gradient(ellipse at 10% 90%, #EFF4EB85 0%, transparent 55%), #FAF7F4',
          boxShadow: '0 4px 20px rgba(58, 43, 31, 0.06)',
        }}
      >
      ...
      <div
        ...
        aria-hidden="true"
        style={{
          background: 'radial-gradient(circle, #7A926833 0%, transparent 70%)',
      ...
      <div
        ...
        aria-hidden="true"
        style={{
          background: 'radial-gradient(circle, #5C705028 0%, transparent 70%)',
          transform: 'translate(-30%, 30%)',
        }}
      />
      ...
      <motion.div {...fade(0)} className="mb-6">
        <div className="relative w-[108px] h-[108px]">
          ...
          <div
            ...
            style={{
              background: 'conic-gradient(from 0deg, #5C7050, #7A9268, #6B8558, #5C7050)',
              opacity: 0.35,
              filter: 'blur(6px)',
            }}
          />
          ...
          <div
            ...
            style={{
              padding: '2.5px',
              background: 'linear-gradient(135deg, #5C7050 0%, #7A9268 50%, #6B8558 100%)',
            }}
          >
  ...
  return (
    <svg width="48" height="72" viewBox="0 0 48 72" fill="none" aria-hidden="true">
      <path
        ...
        fill="#7A9268"
      />
      <path d="M24 4L24 68" stroke="#EFF4EB" strokeWidth="0.8" opacity="0.5" />
      <path
