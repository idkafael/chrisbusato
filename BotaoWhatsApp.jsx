  ...
  return (
    <a
      ...
      style={{
        ...
        textDecoration: 'none',
        boxShadow: '0 6px 20px rgba(37,211,102,0.45), 0 0 0 10px rgba(37,211,102,0.14)',
        transition: 'transform 0.2s ease, box-shadow 0.2s ease',
        WebkitTapHighlightColor: 'transparent',
      }}
      onMouseEnter={e => {
        e.currentTarget.style.transform = 'scale(1.07)'
        e.currentTarget.style.boxShadow = '0 10px 28px rgba(37,211,102,0.55), 0 0 0 14px rgba(37,211,102,0.18)'
      }}
      onMouseLeave={e => {
        e.currentTarget.style.transform = 'scale(1)'
        e.currentTarget.style.boxShadow = '0 6px 20px rgba(37,211,102,0.45), 0 0 0 10px rgba(37,211,102,0.14)'
      }}
    >
      <svg width="31" height="31" viewBox="0 0 24 24" fill="#FFFFFF" aria-hidden="true">
